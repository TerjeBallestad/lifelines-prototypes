...
must_haves:
  truths:
    ...
    - "Activities have capacity profiles for success calculation"
  artifacts:
...
- Capacity profiles vary by activity complexity (visit-store is hardest, rest has no requirements)
- Capacity profiles use realistic values (40-60 range, where 50 is average)
  </action>
...
- All activities have capacityProfile (can be empty for easy activities)
- Capacity profiles use realistic values matching the 0-100 scale
</success_criteria>
